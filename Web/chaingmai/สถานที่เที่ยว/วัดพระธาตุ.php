...
<head>
    <meta charset="UTF-8">
    <title>วัดพระธาตุดอยสุเทพ</title>
...
<body>
    ...
    <div class="container">
        <h1 class="title">วัดพระธาตุดอยสุเทพ</h1>
        
        <div class="images">
            <img src="photo/วัดพระธาตุดอยสุเทพ/page1.jpg" alt="">
            <img src="photo/วัดพระธาตุดอยสุเทพ/page2.jpg" alt="">
            <img src="photo/วัดพระธาตุดอยสุเทพ/page3.jpg" alt="">
        </div>

        <div class="description">
            <p>
                <strong>วัดพระธาตุดอยสุเทพ</strong> วัดพระธาตุดอยสุเทพ นั้นเป็นปูชนียสถานคู่เมืองเชียงใหม่มาตั้งแต่โบราณ ตั้งอยู่บนยอดดอยสุเทพ  
                    นอกจากนี้ยังมี บันไดนาคเจ็ดเศียร ซึ่งทอดยาวขึ้นไป 300 ขั้น และ เจดีย์สีทองทรงเชียงแสน เป็นศิลปะล้านนาที่งดงาม 
                    อีกทั้งที่นี่เป็นพระธาตุประจำคนเกิดปีมะแมตามคติความเชื่อล้านนาอีกด้วย
            </p>
            <p>
                 สำหรับการขึ้นไปสักการะพระธาตุดอยสุเทพ นักท่องเที่ยวสามารถเดินขึ้นบันไดนาคไป 300 ขั้น 
                 เพื่อไปยังวัด หรือใช้บริการรถกระเช้าขึ้น-ลงดอยสุเทพได้ ระหว่างเวลา 05.30-19.30 น.
                 และอย่าพลาดเดินไปชมวิวเมืองเชียงใหม่สวยๆ ที่จุดชมวิวบนวัดกันด้วย
            </p>
        </div>
