...
<body>
    ...
    <div class="content">
        <div class="product-section">
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/S503.jpg" alt="Keyboard">
                <h4>หูฟัง AULA S503 GAMING HEADSET Jack 3.5mm</h4>
                <p>940 บาท</p>
                <button onclick="addToCart('หูฟัง AULA S503 GAMING HEADSET Jack 3.5mm', 940)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/S505.jpg" alt="Keyboard">
                <h4>AULA S505 GAMING HEADSET 7.1</h4>
                <p>1,125 บาท</p>
                <button onclick="addToCart('AULA S505 GAMING HEADSET 7.1', 1,125)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/S609-1.jpg" alt="Keyboard">
                <h4>หูฟัง AULA S609 WIRELESS GAMING HEADSET7.1</h4>
                <p>2,400 บาท</p>
                <button onclick="addToCart('หูฟัง AULA S609 WIRELESS GAMING HEADSET7.1', 2400)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/TWS-AL301.jpg" alt="Keyboard">
                <h4>หูฟังไร้สาย AULA AL301 BLUETOOTH TRUE WIRELESS V5.0</h4>
                <p>1,300 บาท</p>
                <button onclick="addToCart('หูฟังไร้สาย AULA AL301 BLUETOOTH TRUE WIRELESS V5.0', 1,300)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/TWS-AL110.jpg" alt="Keyboard">
                <h4>หูฟังไร้สาย AULA AL110 BLUETOOTH TRUE WIRELESS EARBUDS V5.0</h4>
                <p>725 บาท</p>
                <button onclick="addToCart('หูฟังไร้สาย AULA AL110 BLUETOOTH TRUE WIRELESS EARBUDS V5.0', 725)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
        </div>
...
<script>
    ...
    function getImageURL(name) {
        const images = {
            "หูฟัง AULA S503 GAMING HEADSET Jack 3.5mm": "https://aulathailand.com/wp-content/uploads/2023/07/S503.jpg",
            "AULA S505 GAMING HEADSET 7.1": "https://aulathailand.com/wp-content/uploads/2023/07/S505.jpg",
            "หูฟัง AULA S609 WIRELESS GAMING HEADSET7.1": "https://aulathailand.com/wp-content/uploads/2023/07/S609-1-768x768.jpg",
            "หูฟังไร้สาย AULA AL301 BLUETOOTH TRUE WIRELESS V5.0": "https://aulathailand.com/wp-content/uploads/2023/07/TWS-AL301.jpg",
            "หูฟังไร้สาย AULA AL110 BLUETOOTH TRUE WIRELESS EARBUDS V5.0": "https://aulathailand.com/wp-content/uploads/2023/07/TWS-AL110.jpg"
    };
