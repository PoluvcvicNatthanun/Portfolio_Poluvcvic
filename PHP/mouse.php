...
<body>
    ...
    <div class="content">
        <div class="product-section">
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/S18.jpg" alt="mouse">
                <h4>MOUSE AULA S18 MACRO GAMING MOUSE</h4>
                <p>560 บาท</p>
                <button onclick="addToCart('MOUSE AULA S18 MACRO GAMING MOUSE', 560)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/F820-768x768.jpg" alt="mouse">
                <h4>AULA F820 GAMING MOUSE (MACRO)</h4>
                <p>710 บาท</p>
                <button onclick="addToCart('AULA F820 GAMING MOUSE (MACRO)', 710)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://assets.central.co.th/Onikuma-BlackONIKUMAMizuWiredGamingMouse-MKP0758919-1?$JPEG$&wid=550" alt="Keyboard">
                <h4>ONIKUMA Mizu Wired Gaming Mouse สีดำ เมาส์สำหรับเล่นเกม</h4>
                <p>450 บาท</p>
                <button onclick="addToCart('ONIKUMA Mizu Wired Gaming Mouse สีดำ เมาส์สำหรับเล่นเกม', 450)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2022/08/805.jpg" alt="Keyboard">
                <h4>MOUSE AULA F805 MACRO GAMING MOUSE</h4>
                <p>385 บาท</p>
                <button onclick="addToCart('MOUSE AULA F805 MACRO GAMING MOUSE', 385)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/H510-768x768.jpg" alt="Keyboard">
                <h4>MOUSE AULA H510 MACRO GAMING MOUSE</h4>
                <p>1,285 บาท</p>
                <button onclick="addToCart('MOUSE AULA H510 MACRO GAMING MOUSE', 1,285)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
        </div>
    ...
    <div id="detail-modal" class="modal-overlay">
        <div class="modal-content" style="text-align: left; max-width: 600px;">
            ...
            <button onclick="closeDetailModal()" style="font-family: 'Kanit', sans-serif;">ปิด</button>
        </div>
    </div>
...
<script>
    ...
    function getImageURL(name) {
        const images = {
            "MOUSE AULA S18 MACRO GAMING MOUSE": "https://aulathailand.com/wp-content/uploads/2023/07/S18.jpg",
            "AULA F820 GAMING MOUSE (MACRO)": "https://aulathailand.com/wp-content/uploads/2023/07/F820-768x768.jpg",
            "ONIKUMA Mizu Wired Gaming Mouse สีดำ เมาส์สำหรับเล่นเกม": "https://assets.central.co.th/Onikuma-BlackONIKUMAMizuWiredGamingMouse-MKP0758919-1?$JPEG$&wid=550",
            "MOUSE AULA F805 MACRO GAMING MOUSE": "https://aulathailand.com/wp-content/uploads/2022/08/805.jpg",
            "MOUSE AULA H510 MACRO GAMING MOUSE": "https://aulathailand.com/wp-content/uploads/2023/07/H510.jpg"
    };
