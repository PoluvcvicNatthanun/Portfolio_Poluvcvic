...
<body>
    ...
    <div class="content">
        <div class="product-section">
            <div class="product">
                <img src="https://down-th.img.susercontent.com/file/cn-11134207-7ras8-m79cs05e724y6b" alt="Keyboard">
                <h4>AULA HERO 84 HE</h4>
                <p>2,090 บาท</p>
                <button onclick="addToCart('AULA HERO 84 HE', 2090)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://my-test-11.slatic.net/p/34369e48b6599f2adbb9cfb71e97151a.jpg" alt="Keyboard">
                <h4>RK987 Mechanical Keyboard</h4>
                <p>1,290 บาท</p>
                <button onclick="addToCart('Keyboard RGB', 1,290)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://mercular.s3.ap-southeast-1.amazonaws.com/images/products/2024/07/Ajazz%20AK870Lite%20mm1.png" alt="Keyboard">
                <h4>คีย์บอร์ด Ajazz AK870 Lite Wireless Mechanical Keyboard (EN/TH)</h4>
                <p>729 บาท</p>
                <button onclick="addToCart('คีย์บอร์ด Ajazz AK870 Lite Wireless Mechanical Keyboard (EN/TH)', 729)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/2.jpg" alt="Keyboard">
                <h4>AULA F2088 PRO MECHANICAL GAMING KEYBOARD</h4>
                <p>1,650 บาท</p>
                <button onclick="addToCart('AULA F2088 PRO MECHANICAL GAMING KEYBOARD', 1,650)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
            <div class="product">
                <img src="https://aulathailand.com/wp-content/uploads/2023/07/F3287-768x768.jpg" alt="Keyboard">
                <h4>AULA F3287 MECHANICAL GAMING KEYBOARD</h4>
                <p>1,100 บาท</p>
                <button onclick="addToCart('AULA F3287 MECHANICAL GAMING KEYBOARD', 1,100)" style="font-family: 'Kanit', sans-serif;">เพิ่มลงตะกร้า</button>
            </div>
        </div>
...
<script>
    ...
    function getImageURL(name) {
        const images = {
            "AULA HERO 84 HE": "https://down-th.img.susercontent.com/file/cn-11134207-7ras8-m79cs05e724y6b",
            "Keyboard RGB": "https://my-test-11.slatic.net/p/34369e48b6599f2adbb9cfb71e97151a.jpg",
            "คีย์บอร์ด Ajazz AK870 Lite Wireless Mechanical Keyboard (EN/TH)": "https://mercular.s3.ap-southeast-1.amazonaws.com/images/products/2024/07/Ajazz%20AK870Lite%20mm1.png",
            "AULA F2088 PRO MECHANICAL GAMING KEYBOARD": "https://aulathailand.com/wp-content/uploads/2023/07/2.jpg",
            "AULA F3287 MECHANICAL GAMING KEYBOARD": "https://aulathailand.com/wp-content/uploads/2023/07/F3287.jpg"
    };
