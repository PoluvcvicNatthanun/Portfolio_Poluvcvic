...
<body>
    ...
    <div class="container">
        ...
        <div class="description">
            <p>
                <strong>ปางช้างแม่สา</strong> ดินแดนช้างไทยที่มีจำนวนมาก มีควาญช้างคอยดูแลอย่างใกล้ชิดเลี้ยงด้วยความรักความผูกพัน  
                กลุ่มเพื่อนๆบอกว่าที่นี่เป็นสถานที่ที่ดีที่สุด ได้รับความนิยมโดยเฉพาะชาวต่างชาติ ด้านในปางช้างแม่สา มีการแสดงและกิจกรรมต่าง ๆ มากมาย เช่น การให้อาหาร การวาดรูปของน้องช้าง ป้อนอาหารช้าง พาไปอาบน้ำ การพานั่งชม วิวทิวทัศน์แบบเพลินกันเลยทีเดียว นักท่องเที่ยวเข้าได้ครั้งละไม่เกิน 200 คน โดยจะมีการติดสติ๊กเกอร์ให้  
                แต่ผู้เขียนไม่ได้เข้าไปเพราะอยากนั่งด้านนอกมากกว่า ตรงบริเวณด้านหน้ามีที่นั่งชิล ๆ สบาย ๆ 
                มีร้านอาหาร ร้านกาแฟ เมนูเครื่องดื่มแบบ สมุนไพรธรรมชาติมากมาย มีมุมถ่ายรูปรอบ ๆ บริเวณนั้น
            </p>
            <p>
