...
<head>
    <meta charset="UTF-8">
    <title>Pillows Boutique Hotel</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="description">
            <p>
                <strong>Pillows Boutique Hotel</strong><br> ที่พักเชียงใหม่ ฟีลมินิมอล เรียบง่าย แต่มีความน่ารักอบอุ่น ต้องที่นี่เลย Pillows Boutique Hotel 
                ที่พักสวย สะอาด ตัวโรงแรมตกแต่งสไตล์มินิมอล เน้นความเรียบง่ายแต่ดูดี มีห้องอาหารให้บริการ และที่จอดรถกว้างขวางมาก ขับรถมาเองก็สบายไร้กังวล
            </p>
            <button style="font-family: 'Kanit', sans-serif; " color="white" type="submit"><a href="https://maps.app.goo.gl/eVhYxSfaY3GoP9AS8" target="_blank" rel="noopener" style="text-decoration: none; color:white">Map</a></button>
        </div>
