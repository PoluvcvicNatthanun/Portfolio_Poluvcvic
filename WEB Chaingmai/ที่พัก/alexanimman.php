...
<head>
    <meta charset="UTF-8">
    <title>ALEXA Nimman Hostel</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="description">
            <p>
                <strong>ALEXA Nimman Hostel</strong><br> ที่พักจะตกแต่งสไตล์มินิมอล เรียบง่ายแต่ดูดี ห้องพักกว้าง นอนสบาย มีพื้นที่ใช้สอยให้ไม่รู้สึกอึดอัด เหมาะทั้งกับคนที่มาพักคนเดียว มาคู่ หรือมาเที่ยวกับเพื่อน 
                ยังมีบริการต่างๆ ที่อำนวยความสะดวกแบบครบครัน ทั้งที่จอดรถฟรี บริการรับฝากสัมภาระ และบริการซักรีด
            </p>
            <button style="font-family: 'Kanit', sans-serif; " color="white" type="submit"><a href="https://maps.app.goo.gl/UUzmEcGqyExyuhVv6" target="_blank" rel="noopener" style="text-decoration: none; color:white">Map</a></button>
        </div>
