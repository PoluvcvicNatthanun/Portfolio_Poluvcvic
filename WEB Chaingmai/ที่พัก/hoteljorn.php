...
<head>
    <meta charset="UTF-8">
    <title>JORN Temporary House</title>
...
<body>
    ...
    <div class="container">
        <h1 class="title">JORN Temporary House</h1>
        
        <div class="images">
            <img src="photo/jorn/page1.jpg" alt="">
            <img src="photo/jorn/page2.jpg" alt="">
            <img src="photo/jorn/page3.jpg" alt="">
        </div>

        <div class="description">
            <p>
                <strong>Hotel Aono</strong><br> บ้านทั้งหลังกลางเมืองเชียงใหม่ ขอแนะนำ จร-JORN Temporary House บ้านพักสไตล์วินเทจที่รีโนเวตมาจากบ้านเก่า ใกล้มหาวิทยาลัยเชียงใหม่ เหมาะมากสำหรับคนที่มาพักเป็นกลุ่มหรือครอบครัว
            </p>
            <button style="font-family: 'Kanit', sans-serif; " color="white" type="submit"><a href="https://maps.app.goo.gl/2vkxgwifKj2WUJby7" target="_blank" rel="noopener" style="text-decoration: none; color:white">Map</a></button>
        </div>
